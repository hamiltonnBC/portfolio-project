...
ARCHITECTURE:
  ...
  privacy-engineering: `/privacy-engineering` hosts route-based privacy work tabs; `/privacy-engineering/where-your-data-goes` renders the interactive data-flow demo; `/privacy-engineering/dsr-consent-analytics` renders the DSR & Consent Analytics case study; legacy `/where-your-data-goes` redirects to the nested route
...
<ref label="On-Demand Read Only">
  ...
  src/pages/privacy_engineering/* → Privacy Engineering overview, tab shell, and DSR/Consent Analytics case study
...
<learn>
  - Update `AGENTS.md` if build commands or structural pages/routing parameters change
